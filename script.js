document.addEventListener('DOMContentLoaded', () => {
            // --- CONFIGURATION ---
            const textToType = "Hi! I'm Purushothaman, a.k.a. denji. I'm a computational biologist and a low-key digital artist who loves computers and programming.";
            ...
            const fileId = '1UiLGY_pZ3waIdIU1C_GJCpGcgdvso13cCUBLsoJz9cM';
            document.getElementById('resume-link').href =`https://drive.google.com/file/d/${fileId}/preview`;
            document.getElementById('github-link').href = 'https://github.com/purush0t';
